...
<!--<![endif]-->
	<head>
		...
		*/
		...
		<!--[if lt IE 9]>
		<script src="<?php echo get_template_directory_uri(); ?>/js/html5.js" type="text/javascript"></script><!-- For all versions of IE less than 9. This will allow them to render HTML5 Elements correctly -->
		<![endif]-->
		<?php wp_head(); ?>
		</head>
    <body <?php body_class(); ?>>
